  ...
  const experiences = [
    {
      ...
      period: "Current Role",
      description: "Contributing to enterprise HR systems used by major corporations across Africa.",
      highlights: [
    ...
    },
    {
      ...
      stack: "PHP, Laravel, SQL Server, MySQL, JavaScript, Node.js, Memcached, DigitalOcean, IIS, Apache",
    },
    {
      company: "ScholarshipIQ",
      role: "Backend Engineer",
      period: "Jun 2022 – Apr 2023",
      description: "Architected backend infrastructure for a nationwide academic funding platform.",
      highlights: [
    ...
    },
    {
      ...
      description: "Contributed to educational platforms and API development in an Agile environment.",
      highlights: [
      ...
      stack: "Node.js, PHP/Laravel, MySQL, REST APIs, Git/GitHub, CI/CD pipelines",
    },
  ]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Key roles where I've delivered significant technical impact and leadership.
          </p>
        </div>
            ...
            <Card key={index} className="border border-gray-200 dark:border-gray-800">
              <CardHeader>
                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 md:text-right">{exp.period}</span>
                </div>
              </CardHeader>
              <CardContent>
